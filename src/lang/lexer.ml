...
let parse_time t =
  ...
  with Not_found ->
    ...
    let sub = Pcre_compat.exec ~pat t in
    let g = g sub in
    [g 1; g 2; Some (int_of_string (Pcre_compat.get_substring sub 3)); None]
